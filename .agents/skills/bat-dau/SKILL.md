...
- Mở `.Codex/skills/viet-script/references/setup-audience.md` — **dùng đúng 9 câu trong đó** (1 nguồn sự thật, không tự chế thêm/bớt câu).
...
---
> **Ràng buộc:** skill này là markdown thuần, không script. Việc duy nhất tự động = hỏi → tổng hợp → ghi file (qua công cụ sửa file của Codex). Không cài/chạy gì ngoài.
