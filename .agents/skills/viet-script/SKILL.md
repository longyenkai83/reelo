...
> Thứ tự bất biến: **NGÁCH → TỪ KHOÁ → SẢN PHẨM → FUNNEL → CONTENT** *(xem `AGENTS.md` mục 2B)*. Content là bước **CUỐI** — viết mà không biết mình đang bán gì thì thành bài lẻ.
...
- [ ] **Soi chiến lược — ĐÚNG THỨ TỰ 2 BƯỚC** *(luật thép `AGENTS.md` #6, siết 2026-07-20)*:
