...
def case(tmp_path, monkeypatch):
    ...
    original.status='UNKNOWN'; original.validation_issues=['psychology_mechanism_not_in_library']
    ...
    put(stage_dir/'unknown.json',dict(stage,issue='psychology_mechanism_not_in_library',status='CREATIVE_PLAN_UNKNOWN'))
    ...
    plan=plans.save(raw,context,assets,'DERIVED-C5.9-FROM-'+original.generation_id)
